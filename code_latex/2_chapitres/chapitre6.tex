...
\begin{itemize}
    \item[$\bullet$] $Seuil_{\inf} = Seuil_{optimal} - 10~\%$
    \item[$\bullet$] $Seuil_{\sup} = Seuil_{optimal} + 10~\%$
\end{itemize}

Ce qui crée naturellement les trois zones :

\begin{itemize}
    \item[$\bullet$] une zone de faible risque (verte) : $[\,0 \, ; \, Seuil_{\inf}[$ ;
    \item[$\bullet$] une zone de risque intermédiaire (orange) : $[\,Seuil_{\inf} \, ; \, Seuil_{\sup}[$ ;
    \item[$\bullet$] une zone de risque élevé (rouge) : $[\,Seuil_{\sup} \, ; 100~\%]$.
\end{itemize}
...
\begin{itemize}
    \item[$\bullet$] absence d'investigation pour les niveaux faibles ;
    \item[$\bullet$] contrôles ciblés pour les niveaux intermédiaires ;
    \item[$\bullet$] et investigations approfondies pour les niveaux élevés.
\end{itemize}
