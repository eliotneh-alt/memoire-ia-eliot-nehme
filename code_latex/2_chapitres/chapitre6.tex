...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|>{\raggedright\arraybackslash}p{3.2cm}|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|}
        ...
        \hline
        Variables d'entrée & 54 variables (24 source + 29 enrichies) & Nombre et nature libres : l'outil s'adapte à tout jeu de variables, avec ou sans enrichissement \\
        \hline
        Enrichissement de la base & 30 variables simulées (historique, réparateur, tiers, véhicule, comportement déclaratif, géo-temporel) & Enrichissement facultatif et extensible ; d'autres axes peuvent être ajoutés selon les données réellement disponibles chez l'assureur \\
        \hline
