\chapter{7	Réflexions autour de l'IA et limites de l'outil créé}
\label{chap:limites}
...
\begin{itemize}
    \item[$\bullet$] des indicateurs de fréquence individuelle de sinistralité ;
    \item[$\bullet$] des variables de durée en portefeuille ;
    \item[$\bullet$] des scores de comportement client ;
    \item[$\bullet$] des variables de réseaux (graph analytics) identifiant des connexions entre dossiers.
\end{itemize}
