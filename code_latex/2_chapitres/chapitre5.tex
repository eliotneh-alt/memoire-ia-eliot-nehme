...
Les indicateurs présentés dans cette partie sont l'application pratique des critères de qualité des modèles mis en place présentés en section~\ref{sec:criteres-qualite}.

Pour commencer, on cherche le seuil optimal à partir duquel on peut considérer que les sinistres sont frauduleux à l'aide de l'indicateur de Youden\footnote{Notre agent intègre le calcul du seuil optimal dans son fonctionnement.} (présenté en section~\ref{sec:youden}). Pour le modèle utilisant des arbres de décision, le seuil optimal est de 45~\%.
...
Pour commencer, on cherche le seuil optimal à partir duquel on peut considérer que les sinistres sont frauduleux à l'aide de l'indicateur de Youden (présenté en section~\ref{sec:youden}). Pour le modèle utilisant de \textit{Gradient Boosting}, le seuil optimal est de 50~\%.
