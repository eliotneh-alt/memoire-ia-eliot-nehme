...
\begin{itemize}
    \item[$\bullet$] un delta positif important révèle une sur-représentation anormale d'une caractéristique dans les dossiers de fraude historiques ;
    \item[$\bullet$] à l'inverse, un delta négatif met en avant la sous-représentation de certaines caractéristiques dans les dossiers de fraude.
\end{itemize}

L'agent va ensuite réaliser deux actions de manière autonome :

\begin{itemize}
    \item[$\bullet$] afficher le top~3 des variables jugées comme les plus discriminantes au vu de la variable cible (affichage on Top) ;
