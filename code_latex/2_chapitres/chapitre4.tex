...
\begin{longtable}{|>{\raggedright\arraybackslash}p{2.4cm}|>{\raggedright\arraybackslash}p{1.9cm}|>{\raggedright\arraybackslash}p{1.9cm}|>{\raggedright\arraybackslash}p{1.5cm}|>{\raggedright\arraybackslash}p{2.7cm}|>{\raggedright\arraybackslash}p{2.5cm}|}
    ...
    \hline
    \endlastfoot
    \rowcolor{axehist} insured\_id & Identifiant assuré & Historique assuré & Texte & Identifiant stable de l'assuré, indépendant du numéro de contrat. Permet de relier les dossiers d'un même assuré. & INS000001 … INS0XXXXX \\
    \hline
    \rowcolor{axehist} insured\_nb\_past\_claims & Nb sinistres passés & Historique assuré & Entier & Nombre total de sinistres déclarés par cet assuré sur les 5 dernières années. Distributions chevauchantes, signal modéré. & 0 -- 5 \\
    \hline
    \rowcolor{axehist} insured\_nb\_past\_fraud & Nb fraudes passées confirmées & Historique assuré & Entier & Nombre de fraudes confirmées antérieures pour cet assuré. & 0 -- 3 \\
    \hline
    \rowcolor{axehist} insured\_days\_since\_last\_claim & Jours depuis dernier sinistre & Historique assuré & Entier & Jours depuis le dernier sinistre de cet assuré. & 60 -- 2500 \\
    \hline
    \rowcolor{axehist} insured\_claim\_amount\_history & Montant réclamé cumulé (3 ans) & Historique assuré & Numérique & Montant cumulé (USD) de toutes les réclamations de cet assuré sur 3 ans. & 0 -- 55 000 \\
    \hline
    \rowcolor{axecontrat} policy\_age\_at\_incident\_days & Ancienneté contrat (jours) & Contrat enrichi & Entier & Ancienneté du contrat en jours au moment du sinistre. & 30 -- 3600 \\
    \hline
    \rowcolor{axecontrat} insured\_nb\_policies\_active & Nb contrats actifs & Contrat enrichi & Entier & Nombre de contrats d'assurance actifs simultanément (multi-assurance). & 1 -- 4 \\
    \hline
    \rowcolor{axehist} insured\_address\_changes\_12m & Changements d'adresse (12 mois) & Historique assuré & Entier & Nombre de changements d'adresse dans les 12 derniers mois. & 0 -- 3 \\
    \hline
    \rowcolor{axegarage} repairer\_id & Identifiant réparateur & Réseau garagiste & Texte & Identifiant unique du réparateur mandaté. NONE = pas de réparateur. & GAR0001…\allowbreak GAR0899,\allowbreak NONE \\
    \hline
    \rowcolor{axegarage} repairer\_nb\_claims\_total & Nb dossiers traités (réparateur) & Réseau garagiste & Entier & Nombre total de dossiers sinistres traités par ce réparateur dans la base. & 0 -- 200 \\
    \hline
    \rowcolor{axegarage} repairer\_nb\_fraud\_confirmed & Nb fraudes (réparateur) & Réseau garagiste & Entier & Nombre de fois où ce réparateur apparaît dans un dossier clôturé fraude. & 0 -- \textasciitilde100 \\
    \hline
    \rowcolor{axegarage} repairer\_avg\_invoice\_vs\_market & Ratio facture / marché & Réseau garagiste & Numérique & Ratio facture réparateur / prix marché. >1 = surfacturation. & 0,85 -- 1,55 \\
    \hline
    \rowcolor{axegarage} repairer\_is\_flagged & Réparateur signalé & Réseau garagiste & Booléen 0/1 & Réparateur inscrit en liste de vigilance. & 0 = non signalé / 1 = signalé \\
    \hline
    \rowcolor{axetiers} third\_party\_id & Identifiant tiers & Réseau tiers & Texte & Identifiant du tiers impliqué. NONE si sinistre sans tiers. & TRS00001…\allowbreak TRS09999,\allowbreak NONE \\
    \hline
    \rowcolor{axetiers} third\_party\_nb\_past\_incidents & Nb incidents passés (tiers) & Réseau tiers & Entier & Nombre de fois où ce tiers est apparu dans des dossiers passés. & 0 -- 5 \\
    \hline
    \rowcolor{axetiers} witness\_id & Identifiant témoin & Réseau tiers & Texte & Identifiant du témoin principal. NONE si pas de témoin. & WIT00001…\allowbreak WIT11999,\allowbreak NONE \\
    \hline
    \rowcolor{axetiers} insured\_third\_party\_known & Tiers connu de l'assuré & Réseau tiers & Booléen 0/1 & Assuré et tiers se connaissent (même adresse, téléphone ou lien familial). & 0 = inconnus / 1 = connus \\
    \hline
    \rowcolor{axevehic} vehicle\_id & Identifiant véhicule & Véhicule & Texte & Immatriculation anonymisée. & VEH000001…\allowbreak VEH027999 \\
    \hline
    \rowcolor{axevehic} vehicle\_age\_years & Âge du véhicule (années) & Véhicule & Entier & Âge du véhicule en années. & 1 -- 22 \\
    \hline
    \rowcolor{axevehic} vehicle\_market\_value & Valeur marché du véhicule & Véhicule & Numérique & Valeur argus estimée du véhicule (USD). Distributions très chevauchantes. & 2 000 -- 40 000 \\
    \hline
    \rowcolor{axevehic} vehicle\_overvalue\_ratio & Ratio surévaluation réclamation & Véhicule & Numérique & claim\_amount / vehicle\_market\_value. >1 = réclamation dépasse la valeur du véhicule. & 0,10 -- 5,00 \\
    \hline
    \rowcolor{axevehic} vehicle\_nb\_past\_claims & Nb sinistres passés (véhicule) & Véhicule & Entier & Sinistres antérieurs sur ce véhicule, tous propriétaires confondus. & 0 -- 4 \\
    \hline
    \rowcolor{axevehic} vehicle\_ownership\_duration\_days & Durée possession (jours) & Véhicule & Entier & Jours de possession avant le sinistre. & 20 -- 3500 \\
    \hline
    \rowcolor{axecompo} time\_to\_report\_days & Délai de déclaration (jours) & Comportement déclaratif & Entier & Délai entre sinistre et déclaration. & 0 -- 75 \\
    \hline
    \rowcolor{axecompo} nb\_amendments\_declaration & Nb modifications déclaration & Comportement déclaratif & Entier & Nombre de modifications de la déclaration initiale. & 0 -- 4 \\
    \hline
    \rowcolor{axecompo} declaration\_channel & Canal de déclaration & Comportement déclaratif & Catégoriel & Canal utilisé pour déclarer le sinistre. & web, telephone, agence, courtier \\
    \hline
    \rowcolor{axecompo} injury\_claimed\_without\_medical & Blessure sans justificatif & Comportement déclaratif & Booléen 0/1 & Blessures corporelles déclarées sans justificatif médical. & 0 = justificatif présent / 1 = absent \\
    \hline
    \rowcolor{axetemp} incident\_zip\_fraud\_rate & Taux fraude de la zone & Géographique & Numérique & Taux historique de fraude dans l'État du sinistre, calculé sur la base. & 0,00 -- 0,30 \\
    \hline
    \rowcolor{axetemp} incident\_is\_weekend & Sinistre en weekend & Temporel & Booléen 0/1 & Sinistre un vendredi soir, samedi ou dimanche. & 0 = semaine / 1 = weekend \\
    \hline
    \rowcolor{axetemp} incident\_is\_holiday & Sinistre jour férié & Temporel & Booléen 0/1 & Sinistre un jour férié américain (1er jan, 4 juillet, Thanksgiving, Noël). & 0 = jour normal / 1 = jour férié \\
    \hline
...
Dans cette section, nous présentons la restitution concrète produite par notre outil sur le portefeuille de sinistres simulé (construit à partir des données \textit{Kaggle} enrichies).
...
\begin{itemize}
    ...
    \item[$\bullet$] \textbf{L'analyse des plages et modalités} : le système extrait automatiquement les bornes pour les variables numériques, et liste les différentes catégories pour les variables textuelles, facilitant la détection immédiate de valeurs aberrantes (outliers).
...
\begin{itemize}
    ...
    \item[$\bullet$] De plus, la variable cible de notre étude, fraud\_reported, est correctement identifiée et renseignée à 100~\%, condition sine qua non pour l'entraînement d'un modèle supervisé.
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/chapitre4/3_matrices_correlation.png}
    \caption{Matrices d'association entre variables : coefficient de Pearson (quantitatives), V de Cramér (qualitatives) et rapport de corrélation $\eta^2$ (mixtes)}
    \label{fig:matrice-correlation}
\end{figure}
