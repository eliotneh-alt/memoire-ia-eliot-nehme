...
\begin{table}[H]
    \centering
    \renewcommand{\arraystretch}{1.3}
    \begin{tabularx}{\textwidth}{|>{\centering\arraybackslash}m{2.4cm}|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|}
        \hline
        \rowcolor{accenture}
        \textcolor{white}{\textbf{}} & \textcolor{white}{\textbf{Assurance automobile}} & \textcolor{white}{\textbf{Assurance habitation}} \\
        \hline
        \textbf{Fraude liée aux conditions générales}
        & \begin{itemize}[leftmargin=1.2em, nosep, label=$\bullet$]
