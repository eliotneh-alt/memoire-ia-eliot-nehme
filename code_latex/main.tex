...
%\usepackage{seqsplit}
%\usepackage{pdflscape} % Fait pivoter la page dans le PDF
...
\definecolor{axehist}{HTML}{FBF8E8}    % Historique assuré - crème/jaune très clair
\definecolor{axecontrat}{HTML}{E4ECF6}  % Contrat enrichi - bleu clair
\definecolor{axegarage}{HTML}{EDE7F5}  % Réseau garagiste - violet clair
\definecolor{axetiers}{HTML}{EDE7F5}   % Réseau tiers - violet clair
\definecolor{axevehic}{HTML}{E7F1E4}   % Véhicule - vert clair
\definecolor{axecompo}{HTML}{FBEAEA}   % Comportement déclaratif - rouge/rose clair
\definecolor{axegeo}{HTML}{FBF8E8}     % Géographique - jaune clair
\definecolor{axetemp}{HTML}{D3DBD0}
\definecolor{colchamp}{HTML}{C00000}     % Champ (EN) - rouge
\definecolor{bleu}{HTML}{0C447C}      % Nom (FR) - bleu  : Identifiant / Contrat / Assuré
\definecolor{marron}{HTML}{633806}
\definecolor{vert}{HTML}{00B050}      % Nom (FR) - vert : pour phrases
\definecolor{orange}{HTML}{ED7D31}    % Nom (FR) - orange : pour les phrases
\definecolor{rouge}{HTML}{FF0000}    % Nom (FR) - rouge : pour les phrases
\usetikzlibrary{positioning, shapes.geometric, arrows.meta, shapes.misc, backgrounds, fit, shadows}
\usetikzlibrary{shapes, arrows, positioning}
\setlist[itemize]{itemsep=2pt, topsep=2pt} % Applique ces réglages à toutes les listes itemize
...
\newcommand{\champA}[1]{\textcolor{bleu}{\textbf{#1}}}
\newcommand{\champB}[1]{\textcolor{marron}{\textbf{#1}}}
\newcommand{\nomA}[1]{\textcolor{bleu}{\textit{#1}}}
\newcommand{\nomB}[1]{\textcolor{marron}{\textit{#1}}}
...
%   {\vspace*{25pt}\chaptertitlename\ \thechapter} % Espace au-dessus + Texte "Chapitre X"
...
\include{2_chapitres/chapitre6}
\include{2_chapitres/chapitre7}
\include{2_chapitres/chapitre8}
