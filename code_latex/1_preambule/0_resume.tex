...
In fine, c'est ce dernier qui obtiendrat les meilleures performances (AUC de 0,933, lift de $\times$6,37 au premier décile) tout en concentrant efficacement les fraudes dans un volume restreint de dossiers à investiguer.
...
\underline{\textbf{Note :}} Les schémas et illustrations de ce mémoire ont été réalisés avec l'aide d'outils d'intelligence artificielle générative. De même, une partie des données d'enrichissement de la base a été simulée à l'aide de tels outils, comme précisé en section \ref{sec:enrichissement}
