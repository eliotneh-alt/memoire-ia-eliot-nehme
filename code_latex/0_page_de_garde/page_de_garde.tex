...
\noindent Par : Eliot NEHME \\[0.3cm]
\noindent Titre : Détection de fraude en assurance non-vie grâce à l'intelligence artificielle
\\[0.3cm]
\noindent Confidentialité : \quad $\square$ NON \qquad $\boxtimes$ (Durée : $\square$ 1 an \quad  $\boxtimes2$ 2 ans)
\\
